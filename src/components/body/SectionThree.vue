<template>
  <div class="w-[90%] mx-auto mt-5 mb-3">
    ...
    <div class="text-center">
      <div class="mt-8">
        <h3 class="text-[26px] text-[hsl(208,49%,24%)] mb-4 font-semibold">Free, open, simple</h3>
        <p class="text-[hsl(207,13%,34%)] font-light">
      ...
      <div class="mt-8">
        <h3 class="text-[26px] text-[hsl(208,49%,24%)] mb-4 font-semibold">Powerful tooling</h3>
        <p class="text-[hsl(207,13%,34%)]">
