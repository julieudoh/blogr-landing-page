<template>
  <div class="w-full py-3 sm:py-0 text-center ">
    <a
    ...
    >
      ...
      <img
        :src="lightArrow"
        alt="dropdown icon"
        class="hidden sm:block ml-1"
        :class="{ 'rotate-180': isOpen }"
      />
    </a>

    <div
      class="w-full rounded-sm bg-gray-200 sm:bg-[hsl(0,100%,100%)] p-4 sm:absolute sm:left-0 sm:w-30 sm:border-gray-500  cursor-pointer sm:text-[14px] lg:text-16"
      v-if="isOpen"
      @click="closeDropDown"
    >
      <router-link
